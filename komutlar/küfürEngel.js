...
exports.run = async (bot, message, args) => {
  if (!args[0]) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`Lütfen **aç** Veya **kapat** Yazınız!  ${ayarlar.prefix}küfürengel aç `).setColor("RED"));
