...
exports.run = (client, message, params) => {
  var konum = ''
    ...
    .setColor('RANDOM')
    .setTimestamp()
    .setFooter('Harmony | Sunucu Bilgi', client.user.avatarURL)
    ...
    .addField("» Linkler", `[Bot Davet Linki](https://discordapp.com/oauth2/authorize?client_id=495558874883948544&scope=bot&permissions=8)` +  "**\n**"+`[Destek Sunucusu](https://discord.gg/7KRdpPm)`, false);
    console.log("!sunucu komutu " + message.author.username + '#' + message.author.discriminator + " tarafından kullanıldı.")
